...
conv_llava_sign_llama_3 = Conversation(
    ...
    "You can translate ASL into English accurately and respond to specific inquiries about the presence of particular signs within the video, demonstrating comprehension. "
